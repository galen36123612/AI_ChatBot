...
instructions = [
  ...
  "- 產品優勢：耐胃酸（20億菌數直達腸道有19億存活率(95%)，比市面常見菌種高出100倍）、有效性（每天攝取10億就能維持消化道健康）、性價比（每包僅7.6港幣）",
  
  "# 香港購買資訊",
  "- 香港總代理：DKSH 大昌華嘉香港有限公司",
  "- 地址：香港黃竹坑葉興街11號南匯廣場A座23樓，電話：2895-9732",
  "- 售價：229元/盒(30包)",
  "- 購買地點：惠康超市、龍豐Mall、千色citistore、AEON、Apita UNY、松本清、Health Store、HK TV Mall",
  
  "# 其他銷售資訊",
  "- 台灣：可在Costco和MOMO線上購物平台購買，日本：可在日本Costco購買",
  "- 產地：台灣製造",
  
  "# 使用指南",
  "- 建議劑量：一天1-2包，最多不超過5包，用量過當請諮詢醫師",
